...
export function KanbanColumn({ column, tasks, onTaskClick, onAddTask }: ColumnProps) {
  return (
    <div className="flex flex-col h-full min-w-[300px] w-full">
      <div className={`flex items-center justify-between p-3 bg-slate-900/80 border-t-2 ${columnColors[column]} rounded-t-lg`}>
      ...
      <Droppable droppableId={column}>
        {(provided, snapshot) => (
          <div
            ...
            className={`flex-1 p-3 bg-slate-950/50 border border-slate-800 border-t-0 rounded-b-lg overflow-y-auto min-h-[400px] ${
